...
!----------------------
  ...
  subroutine gfs_interstitial_create (Interstitial, ixs, ixe, Model)
    ...
    if (.not. Model%do_RRTMGP) then
      ...
      allocate (Interstitial%alpha         (ixs:ixe,Model%levs+LTP))
    end if
    ...
    allocate (Interstitial%cldtaulw        (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%cldtausw        (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%cld1d           (ixs:ixe))
    allocate (Interstitial%clouds          (ixs:ixe,Model%levs+LTP,NF_CLDS))
    ...
    allocate (Interstitial%delr            (ixs:ixe,Model%levs+LTP))
    ...
    allocate (Interstitial%dzlyr           (ixs:ixe,Model%levs+LTP))
    ...
    allocate (Interstitial%faerlw          (ixs:ixe,Model%levs+LTP,Model%NBDLW,Model%NF_AELW))
    allocate (Interstitial%faersw          (ixs:ixe,Model%levs+LTP,Model%NBDSW,Model%NF_AESW))
    ...
    allocate (Interstitial%gasvmr          (ixs:ixe,Model%levs+LTP,NF_VGAS))
    ...
    allocate (Interstitial%htlwc           (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%htlw0           (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%htswc           (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%htsw0           (ixs:ixe,Model%levs+LTP))
    ...
    allocate (Interstitial%olyr            (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%plvl            (ixs:ixe,Model%levs+1+LTP))
    allocate (Interstitial%plyr            (ixs:ixe,Model%levs+LTP))
    allocate (Interstitial%prnum           (ixs:ixe,Model%levs))
    allocate (Interstitial%qlyr            (ixs:ixe,Model%levs+LTP))
    ...
    allocate (Interstitial%tlvl            (ixs:ixe,Model%levs+1+LTP))
    allocate (Interstitial%tlyr            (ixs:ixe,Model%levs+LTP))
